...
import { ArrowRight, Code2, Database, Trash2, CheckCircle2, PlayCircle, GitCommit, Settings } from 'lucide-react';
...
export default function ChangeSelectionView({ onNavigate, baselineData, errorMsg, isDemoRepo }: ChangeSelectionViewProps) {
